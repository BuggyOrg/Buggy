...
module.exports = function(grunt) {
  ...
  //
  // function generateBuildPath(path){
  //   return "build/" + file.substring(0, file.lastIndexOf("/") + 1);
  // }
  //
  // function generateBuildFilepath(path){
  //   return "build/" + file.replace(/\.[^/.]+$/, ".js");
  // }
  //
  ...
  //   var file_out = generateBuildFilepath(spec);
  //   var file_out_path = generateBuildPath(spec);
  //   grunt.log.write("file_out " + file_out);
  //   grunt.config("browserify:specFile:src", [file_out]);
  //   grunt.config("browserify:specFile:dest", file_out_path + getFileName(file_out) + ".min.js");
  ...
  //
  //   var file_out_path = generateBuildPath(file);
  ...
  //   var file_out = generateBuildFilepath(file);
